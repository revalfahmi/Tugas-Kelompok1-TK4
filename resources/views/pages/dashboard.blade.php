                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="badge badge-complete">Profit</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                    @empty
...
<script>
    jQuery(document).ready(function($) {
        ...
        // Pie chart flotPie1
        var piedata = [
            { label: "SalesUp", data: [[1,{{ $pie['salesupto10'] }}]], color: '#5c6bc0'},
            { label: "OverBudget", data: [[1,{{ $pie['buyOverBudget'] }}]], color: '#ef5350'},
            { label: "StockLow", data: [[1,{{ $pie['stockIsRunningLow'] }}]], color: '#66bb6a'}
        ];
